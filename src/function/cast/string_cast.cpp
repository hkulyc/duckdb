...
static BoundCastInfo VectorStringCastNumericSwitch(BindCastInput &input, const LogicalType &source,
	...
	case LogicalTypeId::UHUGEINT:
		return BoundCastInfo(&VectorCastHelpers::TryCastStrictLoop<string_t, uhugeint_t, duckdb::TryCast>, ScalarFunctionInfo("TryCast::Operation", {"string_t", "uhugeint_t"}, {ScalarFunctionInfo::NumericCastWrapper}));
