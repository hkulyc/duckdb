...
void ConcatFun::RegisterFunction(BuiltinFunctions &set) {
	...
	concat_op.AddFunction(
	    ScalarFunction({LogicalType::ANY, LogicalType::ANY}, LogicalType::VARCHAR, ConcatOperator, ScalarFunctionInfo("ConcatOperator", {}, {ScalarFunctionInfo::VectorFrontWrapper, ScalarFunctionInfo::ConstantVectorWrapper})));
