...
// bind, 	                          dependency_function_t dependency, function_statistics_t statistics,
// init_local_state_t init_local_state, 	                          LogicalType varargs, FunctionSideEffects
// side_effects, 	                          FunctionNullHandling null_handling) 	:
// ScalarFunction(std::move(arguments), std::move(return_type), std::move(function), bind, dependency, 		statistics,
// init_local_state, std::move(varargs), side_effects, null_handling), function_info(std::move(function_info)) {}
